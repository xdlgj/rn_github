...
class SearchPage extends Component {
  ...
  renderNavBar = () => {
    ...
    return (
      <View
        style={{backgroundColor: theme.themeColor, flexDirection: 'row', alignItems: 'center', height: (Platform.OS === 'ios') ? GlobalStyles.nav_bar_height_ios : GlobalStyles.nav_bar_hegiht_android}}
      >
        {backButton}
        {inputView}
        {rightButton}
